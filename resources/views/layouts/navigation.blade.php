<nav x-data="{ open: false }" class="bg-gradient-to-r from-blue-600 to-blue-800 dark:from-gray-800 dark:to-gray-900 shadow-lg transition-colors duration-300">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 rounded-lg text-white bg-blue-700 dark:bg-gray-700 hover:bg-blue-500 dark:hover:bg-gray-600 focus:outline-none transition ease-in-out duration-150 shadow-md">
                            <div class="flex items-center space-x-2">
                                <div class="w-8 h-8 bg-white dark:bg-gray-300 rounded-full flex items-center justify-center text-blue-600 dark:text-gray-800 font-bold">{{ substr(Auth::user()->name, 0, 1) }}</div>
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('profile.edit')" class="hover:bg-blue-50 dark:hover:bg-gray-700 dark:text-gray-300">
                            👤 Profil Saya
                        </x-dropdown-link>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')"
                                             ...
                                             class="text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-gray-700 hover:text-red-800 dark:hover:text-red-300">
                                🚪 Logout
                            </x-dropdown-link>
                        </form>
                    </x-slot>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-blue-200 dark:text-gray-400 hover:text-white hover:bg-blue-700 dark:hover:bg-gray-800 focus:outline-none transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-blue-700 dark:bg-gray-800">
        ...
        <div class="pt-4 pb-1 border-t border-blue-600 dark:border-gray-700">
            <div class="px-4 pb-3">
            ...
            <div class="space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <a href="{{ route('logout') }}"
                       ...
                       class="block px-4 py-2 text-red-300 dark:text-red-400 hover:text-red-100 hover:bg-red-600 dark:hover:bg-gray-700 rounded-lg">
                        🚪 Logout
                    </a>
                </form>
            </div>
