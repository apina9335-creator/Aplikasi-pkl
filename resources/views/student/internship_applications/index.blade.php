...
<div class="py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        <div class="mb-8 flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Aplikasi PKL Saya</h1>
                <p class="mt-2 text-gray-600 dark:text-gray-300">Kelola pendaftaran magang Anda</p>
            </div>
                    ...
                    <div class="space-y-4">
                            ...
                            <div class="bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                                <div class="p-6 flex flex-col md:flex-row justify-between items-start">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        @if($app->cv_path)
                                            <a href="{{ Storage::url($app->cv_path) }}" target="_blank" class="px-4 py-2 bg-indigo-500 text-white rounded hover:bg-indigo-600 transition flex items-center text-sm">📄 File</a>
                                        @endif
                        ...
                        @empty
                            <div class="bg-white rounded-lg shadow-md p-12 text-center border-dashed border-2 border-gray-300">
                                ...
                                <a href="{{ route('student.internship-applications.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150">+ Buat Lamaran Pertama</a>
                            </div>
                        @endforelse
                    </div>
                @endif
